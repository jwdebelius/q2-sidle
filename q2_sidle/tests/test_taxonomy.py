    ...
    def test_reconstruct_taxonomy_none_ignore_ignore(self):
        known = pd.Series(
            data=['k__DCU;p__Superhero;c__Gotham;o__Civillian;f__;g__;s__',
                  ...
                  'k__DCU;p__Superhero;c__Gotham;o__Batfamily;f__Oracle;g__|g__Gordon;g__|g__Gordon',
                  'k__DCU;p__Superhero;c__Gotham;o__Batfamily;f__Batman;g__|g__Grayson|g__Wayne;g__|g__Grayson|g__Wayne',
                  'k__DCU;p__Superhero;c__Gotham;o__Batfamily;f__Robin;g__Grayson;s__Dick',
                  'k__DCU;p__Superhero;c__Gotham;o__Batfamily;f__Robin;g__Drake|g__Todd;g__Drake|g__Todd',
                  ],
    ...
    def test_reconstruct_taxonomy_gg_inheriet_missing(self):
        known = pd.Series(
            data=['k__DCU; p__Superhero; c__Gotham; o__Civillian; o__Civillian; o__Civillian; o__Civillian',
                  'k__DCU; p__Superhero; c__Gotham; o__Batfamily; f__Batgirl; g__Gordon; s__Barbara',
                  'k__DCU; p__Superhero; c__Gotham; o__Batfamily; f__Oracle; f__Oracle|g__Gordon; f__Oracle|g__Gordon',
                  'k__DCU; p__Superhero; c__Gotham; o__Batfamily; f__Batman; f__Batman|g__Grayson|g__Wayne; f__Batman|g__Grayson|g__Wayne',
                  'k__DCU; p__Superhero; c__Gotham; o__Batfamily; f__Robin; g__Grayson; s__Dick',
                  'k__DCU; p__Superhero; c__Gotham; o__Batfamily; f__Robin; g__Drake|g__Todd; g__Drake|g__Todd',
                  ],
            index=pd.Index(['seq01', 'seq03|seq04', 'seq06|seq07', 'seq08|seq09|seq10', 'seq12', 'seq13|seq14'], name='Feature ID'),
    ...
    def test_reconstruct_taxonomy_gg_merge_ignore(self):
        known = pd.Series(
            data=['k__DCU; p__Superhero; c__Gotham; o__Civillian; o__Civillian; o__Civillian; o__Civillian',
                  ...
                  'k__DCU; p__Superhero; c__Gotham; o__Batfamily; f__Batman; g__Grayson|g__Wayne; g__Grayson|g__Wayne',
                  'k__DCU; p__Superhero; c__Gotham; o__Batfamily; f__Robin; g__Grayson; s__Dick',
                  'k__DCU; p__Superhero; c__Gotham; o__Batfamily; f__Robin; g__Drake|g__Todd; g__Drake|g__Todd',
                  ],
            index=pd.Index(['seq01', 'seq03|seq04', 'seq06|seq07', 'seq08|seq09|seq10', 'seq12', 'seq13|seq14'], name='Feature ID'),
    ...
    def test_test_reconstruct_taxonomy_silva_ignore_ignore(self):
        known = pd.Series(
            data=['D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Civillian;D_4__ambigious taxa;D_5__ambigious taxa;D_6__ambigious taxa',
                  ...
                  'D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Batfamily;D_4__Batman;D_5__Grayson|D_5__Wayne|D_5__ambigious batman;D_5__Grayson|D_5__Wayne|D_5__ambigious batman',
                  'D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Batfamily;D_4__Robin;D_5__Grayson;D_6__Dick',
                  'D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Batfamily;D_4__Robin;D_5__Drake|D_5__Todd;D_5__Drake|D_5__Todd',
                  ],
            index=pd.Index(['seq01', 'seq03|seq04', 'seq06|seq07', 'seq08|seq09|seq10', 'seq12', 'seq13|seq14'], name='Feature ID'),
            name='Taxon',
        )
    ...
    def test_reconstruct_taxonomy_silva_inherit_missing(self):
        known = pd.Series(
            data=['D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Civillian;D_3__Civillian;D_3__Civillian;D_3__Civillian',
                  'D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Batfamily;D_4__Batgirl;D_5__Gordon;D_6__Barbara',
                  'D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Batfamily;D_4__Oracle;D_4__Oracle|D_5__Gordon;D_4__Oracle|D_5__Gordon',
                  'D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Batfamily;D_4__Batman;D_4__Batman|D_5__Grayson|D_5__Wayne;D_4__Batman|D_5__Grayson|D_5__Wayne',
                  'D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Batfamily;D_4__Robin;D_5__Grayson;D_6__Dick',
                  'D_0__DCU;D_1__Superhero;D_2__Gotham;D_3__Batfamily;D_4__Robin;D_5__Drake|D_5__Todd;D_5__Drake|D_5__Todd',
                  ],
            index=pd.Index(['seq01', 'seq03|seq04', 'seq06|seq07', 'seq08|seq09|seq10', 'seq12', 'seq13|seq14'], name='Feature ID'),
